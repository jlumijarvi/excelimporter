...
<div id="importExcel">
    ...
    <div class="well">
        Select an Excel file that will be imported to the database. File's first row has to be a header row.
    </div>
    <div class="form file-upload" role="form" runat="server">
        <asp:Panel ID="fileForm" CssClass="form-group form-inline" runat="server">
            ...
            <asp:TextBox ID="SelectedFile" CssClass="form-control fullWidth" ReadOnly="true" runat="server" />
